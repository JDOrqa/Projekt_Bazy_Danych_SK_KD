// Plik: components/Navbar.js
// Pasek nawigacyjny – widoczny po zalogowaniu, zawiera linki i przycisk wylogowania.
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
      <div className="container">
        <Link className="navbar-brand" to="/dashboard">Wędkarz</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <span className="navbar-text me-3">Witaj, {user.imie}</span>
