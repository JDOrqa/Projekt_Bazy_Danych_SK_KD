...
Revision ID: 8b5618faf5df
Revises: 
Create Date: 2026-04-22 17:27:06.902267
...
def upgrade() -> None:
    # ### commands auto generated by Alembic - skipped on purpose ###
    # Ten blok został wyłączony, ponieważ zawiera polecenia DROP tabel zależnych
    # od rozszerzenia postgis_tiger_geocoder (np. countysub_lookup) — próba ich
    # usunięcia powodowała błąd: "DependentObjectsStillExistError".
    #
    # Aby poprawnie zastosować migracje w środowisku z zainstalowanym rozszerzeniem
    # tiger_geocoder, pomijamy tutaj usuwanie tabel generowanych przez to rozszerzenie.
    #
    # Jeżeli potrzebujesz odtworzyć pełny blok wygenerowany przez Alembic,
    # przywróć zawartość tego miejsca z oryginalnego pliku migracji.
    #
    # Pozostawiamy funkcję upgrade jako no-op, żeby kolejne migracje (np. Twoja
    # 20260611_add_db_functions_triggers) mogły się wykonać bez konfliktu.
    return
    # ### end skipped block ###
